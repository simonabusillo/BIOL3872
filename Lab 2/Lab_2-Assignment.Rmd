...
```{r}
# a)
field_samples$depth_ft <- field_samples$depth_m*3.8

# b)
field_samples$is_deep <- ifelse(field_samples$depth_m >4,"Deep", "Not Deep")
...
#strong, negative correlation between depth and species count in the marine survey
